...
def setup_gemstone():
    ...
    # 광석 추가
    gemstone_group.add(Gemstone(gemstone_imgs[0], (400, 400), s_g_price, s_g_speed))
    gemstone_group.add(Gemstone(gemstone_imgs[0], (600, 450), s_g_price, s_g_speed))
    gemstone_group.add(Gemstone(gemstone_imgs[0], (800, 400), s_g_price, s_g_speed))
    gemstone_group.add(Gemstone(gemstone_imgs[0], (11500, 380), s_g_price, s_g_speed))

    gemstone_group.add(Gemstone(gemstone_imgs[1], (300, 500), b_g_price, b_g_speed))
    gemstone_group.add(Gemstone(gemstone_imgs[1], (800, 500), b_g_price, b_g_speed))

    gemstone_group.add(Gemstone(gemstone_imgs[2], (300, 380), stone_price, stone_speed))
    gemstone_group.add(Gemstone(gemstone_imgs[2], (700, 330), stone_price, stone_speed))
    gemstone_group.add(Gemstone(gemstone_imgs[2], (1000, 480), stone_price, stone_speed))

    gemstone_group.add(Gemstone(gemstone_imgs[3], (900, 400), dia_price, dia_speed))
    gemstone_group.add(Gemstone(gemstone_imgs[3], (150, 500), dia_price, dia_speed))
...
# 마무리 exe 파일화 pip install pyinstaller
# pyinstaller -w 13_setup.py
# 관련 png 파일을 C:\Users\PC\Desktop\p\Gold_Miner\dist\13_setup 에 복사
# 현재 exe 파일 실행시 오류가 존재 png 파일의 경로를 절대경로로 변경하면 될듯
